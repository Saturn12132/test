...
local OrionLib = {
	...
	Themes = {
			...
			Second = Color3.fromRGB(247, 247, 247),
			Stroke = Color3.fromRGB(227, 229, 232),
			Divider = Color3.fromRGB(227, 229, 232),
			Text = Color3.fromRGB(75, 75, 75),
			Text3 = Color3.fromRGB(75, 75, 75),
			TextDark = Color3.fromRGB(50, 50, 50),
		},
		Darkmode = {
			Main = Color3.fromRGB(33, 37, 41),
			Second = Color3.fromRGB(52, 58, 64),
			Stroke = Color3.fromRGB(108, 117, 125),
			Divider = Color3.fromRGB(108, 117, 125),
	...
	local WindowStuff = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 10), {
		...
		SetChildren(SetProps(MakeElement("TFrame"), {
			...
			AddThemeObject(SetProps(MakeElement("Label", "Using: "..Executor), {
				Size = UDim2.new(1, -60, 0, 13),
				Position = WindowConfig.HidePremium and UDim2.new(0, 50, 0, 19) or UDim2.new(0, 50, 0, 15),
				Font = Enum.Font.GothamBold,
				ClipsDescendants = true
			}), "Text"),
